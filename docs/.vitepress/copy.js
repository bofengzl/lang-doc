...
export default defineConfig({
  ...
  themeConfig: {
    ...
    // 导航栏
    nav: [
      { text: 'Golang', link: '/go/introduction', activeMatch: '/go' },
      // { text: 'lang-dev', link: '/guide/what-is-vitepress', activeMatch: '/guide' },
      {
        text: '案例',
        items: [
    ...
    sidebar: [
      {
        text: 'Golang',
        items: generateDirectory()
        // items: [
        //   { text: '介绍', link: '/go/what-is-vitepress' },
